...
//@Route(value = "admin/:samplePersonID?/:action?(edit)", layout = MainView.class)
@PageTitle("Admin")
public class AdminView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "admin/%d/edit";
    ...
    public AdminView(@Autowired SamplePersonService samplePersonService) {
